...
export const ui = {
  en: {
    ...
    'map.maximize': 'Maximize map',
    'map.minimize': 'Exit expanded view',
    'map.membershipLabel': 'Filmography',
    'map.referencesLabel': 'References',
    'map.locate': 'Locate in map',
    'map.openReference': 'Open file',
  ...
  es: {
    ...
    'map.maximize': 'Maximizar mapa',
    'map.minimize': 'Salir de la vista ampliada',
    'map.membershipLabel': 'Filmografía',
    'map.referencesLabel': 'Referencias',
    'map.locate': 'Ubicar en el mapa',
    'map.openReference': 'Abrir ficha',
